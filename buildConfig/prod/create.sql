...
(6, 	'game.listAll',	        NULL,	4),
(7, 	'game.update',	        NULL,	1),
(8, 	'gamePage.read',	    NULL,	4),
(9,	    'gamePage.update',	    NULL,	1),
(10,	'match.create',	        NULL,	1),
(11,	'match.delete',	        NULL,	1),
(12,	'match.read',	        NULL,	4),
(13,	'match.update',	        NULL,	1),
(14,	'page.read',	        NULL,	4),
(15,	'school.listAll',	    NULL,	4),
(16,	'stage.create',	        NULL,	1),
(17,	'stage.delete', 	    NULL,	1),
(18,	'stage.read',	        NULL,	4),
(19,	'stage.update', 	    NULL,	1),
(20,	'team.create',	        NULL,	3),
(21,	'team.generateJoinString',	    NULL,	1),
(22,	'team.generateJoinStringMy',	NULL,	3),
(23,	'team.join',	        NULL,	3),
(24,	'team.kick',	        NULL,	1),
(25,	'team.kickTeam',	    NULL,	3),
(26,	'team.leave',	        NULL,	3),
(27,	'team.listParticipating',	    NULL,	4),
(28,	'team.listParticipatingDiscord',	NULL,	1),
(29,	'team.read',	        NULL,	4),
(30,	'user.delete',	        NULL,	1),
(31,	'user.deleteMe',	    NULL,	3),
(32,	'user.exists',	        NULL,	3),
(33,	'user.listTeams',	    NULL,	1),
(34,	'user.listTeamsMe',	    NULL,	3),
(35,	'user.permissionList',	NULL,	1),
(36,	'user.permsListMe',	    NULL,	3),
(37,	'user.read',	        NULL,	1),
(38,	'user.readMe',	        NULL,	3),
(39,	'user.update',	        NULL,	1),
(40,	'user.updateMe',	    NULL,	3),
(41,	'assignedRole.create',	NULL,	1),
(42,	'assignedRole.read',	NULL,	4),
(43,	'assignedRole.update',	NULL,	1),
(44,	'assignedRole.delete',	NULL,	1),
(45,	'assignedRole.listPermissions',	NULL,	4),
(46,	'assignedRole.listAll',	NULL,	1),
(47,	'assignedRolePermission.create',	NULL,	1),
(48,	'assignedRolePermission.read',	NULL,	4),
(49,	'assignedRolePermission.update',	NULL,	1),
(50,	'assignedRolePermission.delete',	NULL,	1),
(51,	'generatedRole.create',	NULL,	1),
(52,	'generatedRole.read',	NULL,	4),
(53,	'generatedRole.update',	NULL,	1),
(54,	'generatedRole.delete',	NULL,	1),
(55,	'generatedRole.listPermissions',	NULL,	4),
(56,	'generatedRole.listAll',	NULL,	1),
(57,	'generatedRolePermission.create',	NULL,	1),
(58,	'generatedRolePermission.read',	NULL,	4),
(59,	'generatedRolePermission.update',	NULL,	1),
(60,	'generatedRolePermission.delete',	NULL,	1),
(61,	'userRole.create',	NULL,	1),
(62,	'userRole.read',	NULL,	4),
(63,	'userRole.update',	NULL,	1),
(64,	'userRole.delete',	NULL,	1),
(65,    'user.generatedRolesList',  NULL, 1),
(66,    'user.generatedRolesListMe',    NULL, 4),
(67,    'user.assignedRolesList',    NULL, 4),
(68,    'user.assignedRolesListMe', NULL, 1),
(69,    'permission.listAll', NULL, 1);
